  ...
  render() {
    ...
    return (
      <div className="About-Page" ref="AboutRoot">
        <div onClick={returnToHome} className="About-CloseButton">
          ...
          <div className="About-RightPanel">
            <div className="About-TextWrapper">
              <p className="About-Desc">
                A place for my sketches, most of them are not optimised so it
                take a bit of time to load, please be patient. And apologies for
                some of the sketches might not work across different devices and
                platforms. This is more a playground for me to tryout ideas.
              </p>
              <p className="About-Desc with-link">
              ...
              <p className="About-Desc with-link">
                ...
                <a href="https://github.com/yiwenl/Alfrid" target="_blank">
                  <p className="About-Link">https://github.com/yiwenl/Alfrid</p>
                </a>
              </p>
              <br />
              <a href="http://blog.bongiovi.tw" target="_blank">
                <p className="About-Link">blog.bongiovi.tw</p>
              </a>
              <a href="https://twitter.com/yiwen_lin" target="_blank">
                <p className="About-Link">@yiwen_lin</p>
              </a>
            </div>
          </div>
        </ReactCSSTransitionGroup>
        <div className="About-Background" onClick={returnToHome} />
      </div>
    );
  }
}
